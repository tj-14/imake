      ...
      <div className="App">
        <Router history={browserHistory}>
          <div>
            ...
            <Route path="/newproduct/:uid" render={(props) => (<ProductPage {...props} data={this.state.data} addNewData={(detail) => this.addNewData(detail)} data={this.state.data} reviewData={reviewData}/>)}/>
