...
var continentColors = ['#C0C0C0', '#CCE5FF', '#66B2FF', '#0080FF', '#3333FF', '#0000CC'];
...
class NewProductPage extends Component {
  ...
  render(){
    ...
    const genderData = [
      {label: "Female", value: this.state.genderDistribution[0], color: "#FF0000"},
      {label: "Male", value: this.state.genderDistribution[1], color: "#0000FF"}
    ]
          ...
          <div className="ProductPage-Right">
            {
              ...
              <div className="dataBox">
                ...
                {priceDiv}
                {descriptionDiv}
                <div className="continentLabel">Continent view history distribution:</div>
        ...
        <div className="ProductPage-Mid">
          <Router>
            <div style={{width: "100%"}}>
              ...
              <Route path="/newproduct/:uid" render={(props) => (<NewProductPage {...props} addNewData={this.props.addNewData} data={this.props.data} reviewData={this.props.reviewData}/>)}/>
            </div>
          </Router>
        </div>
      </div>
