...
class ProductDetail extends Component {
  ...
  render(){
    ...
    for (var i=0; i < 6; i++) {
        var salesCount = product[0].continentSales[i]
        if (salesCount < 100) {
