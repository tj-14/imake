...
class NewProductPage extends Component {
  ...
  render(){
    ...
    for (var i=0; i < 6; i++) {
        var salesCount =  dummyProduct.continentSales[i]//product[0].continentSales[i]
        if (salesCount < 100) {
